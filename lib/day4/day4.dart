...
class Day4
  ...
  @override
  Iterable<Iterable<Set<int>>> preprocess(Iterable<String> value) => value.map(
  ...
  Iterable<Iterable<Set<int>>> processPart1(
    Iterable<Iterable<Set<int>>> value,
  ) =>
      value.where(
        (sectionPair) =>
  ...
  @override
  int postprocess(Iterable<Iterable<Set<int>>> value) => value.length;
}
